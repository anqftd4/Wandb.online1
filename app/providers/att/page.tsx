...
const providerData = siteConfig.providers.att
...
const samplePlans = [
  {
    ...
    speed: '300 Mbps',
    price: '$55/mo',
    features: ['Symmetrical speeds', 'No data caps', 'Free equipment'],
  },
  {
    name: 'AT&T Fiber 500',
    speed: '500 Mbps',
    price: '$65/mo',
    features: ['Symmetrical speeds', 'HBO Max included', 'Smart home ready'],
  },
  {
    name: 'AT&T Fiber 1 Gig',
    speed: '1000 Mbps',
    price: '$80/mo',
    features: ['Symmetrical speeds', 'Ideal for 12+ devices', 'All-Fi WiFi system'],
  },
]
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Reveal delay={0.1}>
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
                Explore sample {providerData.name} Fiber internet plans. Actual availability and pricing 
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="font-display font-bold text-2xl text-slate-900 dark:text-white mb-6 text-center">
              About {providerData.name} Fiber
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p>
                {providerData.name} offers fiber-optic internet service in many metropolitan areas 
                across the United States. AT&T Fiber provides symmetrical upload and download speeds, 
                making it well-suited for video calls, gaming, and homes with multiple connected devices.
              </p>
              <p>
                In areas where fiber is not available, {providerData.name} may offer other internet 
                options. Their fiber service typically includes no data caps and may come with 
                streaming service bundles depending on the plan.
              </p>
              <p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Reveal delay={0.1}>
            <p className="text-slate-600 dark:text-slate-400 mb-8">
              Call to verify if {providerData.name} Fiber is available at your address and get current pricing.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <a

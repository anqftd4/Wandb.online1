...
const providerData = siteConfig.providers.verizon
...
const samplePlans = [
  {
    ...
    speed: '300 Mbps',
    price: '$49.99/mo',
    features: ['Symmetrical speeds', 'No annual contract', 'Free router for 12 mo'],
  },
  {
    name: 'Fios 500',
    speed: '500 Mbps',
    price: '$69.99/mo',
    features: ['Symmetrical speeds', 'Ideal for families', 'Wi-Fi 6 router'],
  },
  {
    name: 'Fios Gigabit',
    speed: '940 Mbps',
    price: '$89.99/mo',
    features: ['Near-gigabit speeds', 'Work from home ready', 'Best for power users'],
  },
]
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Reveal delay={0.1}>
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
                Explore sample {providerData.name} Fios plans. Actual availability and pricing 
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="font-display font-bold text-2xl text-slate-900 dark:text-white mb-6 text-center">
              About {providerData.name} Fios
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p>
                {providerData.name} Fios is a fiber-optic internet service available in select areas, 
                primarily in the Northeastern United States. Fios is known for offering symmetrical 
                upload and download speeds, which can be beneficial for video conferencing, 
                uploading large files, and streaming.
              </p>
              <p>
                Availability is limited to areas where {providerData.name} has installed fiber-optic 
                infrastructure. If Fios is not available at your address, other options may be 
                available. Call to check what services are offered at your location.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Reveal delay={0.1}>
            <p className="text-slate-600 dark:text-slate-400 mb-8">
              Call to verify if {providerData.name} Fios is available at your address and get current pricing.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <a

...
const providerData = siteConfig.providers.spectrum
...
const samplePlans = [
  {
    ...
    speed: '300 Mbps',
    price: '$49.99/mo',
    features: ['No contracts', 'Free modem', 'Free security suite'],
  },
  {
    name: 'Spectrum Internet Ultra',
    speed: '500 Mbps',
    price: '$69.99/mo',
    features: ['No contracts', 'Faster upload speeds', 'Free modem'],
  },
  {
    name: 'Spectrum Internet Gig',
    speed: '1000 Mbps',
    price: '$89.99/mo',
    features: ['No contracts', 'Best for large households', 'Premium WiFi router'],
  },
]
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delay={0.1}>
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p>
                {providerData.name} is one of the largest cable internet providers in the United States, 
                offering service across 41 states. Their network primarily uses hybrid fiber-coaxial 
                (HFC) technology to deliver internet service.
              </p>
              <p>
                One notable feature of {providerData.name} is their no-contract policy, which allows 
                customers to cancel without early termination fees. They also include a free modem 
                with their service, though there may be a separate charge for advanced WiFi routers.
              </p>
              <p>
